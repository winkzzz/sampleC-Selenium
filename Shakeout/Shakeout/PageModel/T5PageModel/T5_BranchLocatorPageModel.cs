...
namespace PageModel
{
    ...
    /// </summary>
    public class T5_BranchLocatorPageModel : BaseSeleniumPageModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="T5_BranchLocatorPageModel" /> class.
        /// </summary>
        /// <param name="testObject">The test object</param>
        public T5_BranchLocatorPageModel(SeleniumTestObject testObject) : base(testObject)
        {
        }
