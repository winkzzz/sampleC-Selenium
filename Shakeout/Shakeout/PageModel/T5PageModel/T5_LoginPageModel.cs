...
namespace PageModel
{
    ...
    /// </summary>
    public class T5_LoginPageModel : BaseSeleniumPageModel
    {
        /// <summary>
        /// The page url
        /// </summary>
        private static readonly string PageUrl = "https://cfsfiserv-s.fiservmobileapps.com/T5REL212SMT/SignIn.aspx";

        /// <summary>
        /// Initializes a new instance of the <see cref="T5_LoginPageModel" /> class.
        /// </summary>
        /// <param name="testObject">The test object</param>
        public T5_LoginPageModel(SeleniumTestObject testObject) : base(testObject)
        {
        }
        ...
        public T5_RememberThisDevicePageModel LoginWithValidCredentials(string userName, string password)
        {
        ...
        public T5_KBAPageModel LoginWithValidCredentialsForKBA(string userName, string password)
        {
            this.EnterCredentials(userName, password);
            this.ContinueButton.Click();
            return new T5_KBAPageModel(this.TestObject);
        }

        public T5_SCQPageModel LoginWithValidCredentialsForSCQ(string userName, string password)
        {
            this.EnterCredentials(userName, password);
            this.ContinueButton.Click();
            return new T5_SCQPageModel(this.TestObject);
        }
