...
namespace PageModel
{
    ...
    /// </summary>
    public class T5_EStatementsPageModel : BaseSeleniumPageModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="T5_EStatementsPageModel" /> class.
        /// </summary>
        /// <param name="testObject">The selenium test object</param>
        public T5_EStatementsPageModel(SeleniumTestObject testObject) : base(testObject)
        {
        }
