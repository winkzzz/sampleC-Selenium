...
namespace PageModel
{
    ...
    /// </summary>
    public class T4_UpdateContactInformationPageModel : BaseSeleniumPageModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="T4_UpdateContactInformationPageModel" /> class.
        /// </summary>
        /// <param name="testObject">The selenium test object</param>
        public T4_UpdateContactInformationPageModel(SeleniumTestObject testObject) : base(testObject)
        {
        }
