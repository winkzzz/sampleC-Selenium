...
namespace PageModel
{
    ...
    /// </summary>
    public class T4_SCQPageModel : BaseSeleniumPageModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="T4_SCQPageModel" /> class.
        /// </summary>
        /// <param name="testObject">The selenium test object</param>
        public T4_SCQPageModel(SeleniumTestObject testObject) : base(testObject)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public T4_RememberThisDevicePageModel ClickSubmit()
        {
