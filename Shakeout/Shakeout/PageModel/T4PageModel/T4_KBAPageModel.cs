...
namespace PageModel
{
    ...
    /// </summary>
    public class T4_KBAPageModel : BaseSeleniumPageModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="T4_KBAPageModel" /> class.
        /// </summary>
        /// <param name="testObject">The selenium test object</param>
        public T4_KBAPageModel(SeleniumTestObject testObject) : base(testObject)
        {
        }
